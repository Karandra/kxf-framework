...
namespace kxf
{
	class KXF_API IGraphicsPath: public RTTI::ExtendInterface<IGraphicsPath, IGraphicsObject>
	{
		kxf_RTTI_DeclareIID(IGraphicsPath, {0x1c3cae6c, 0xf9a3, 0x4d24, {0xbd, 0xa0, 0x16, 0x18, 0x2d, 0x7d, 0x46, 0xc2}});
