...
namespace kxf
{
	class KXF_API WidgetEvent: public RTTI::DynamicImplementation<WidgetEvent, BasicEvent, IWidgetEvent>
	{
		kxf_RTTI_DeclareIID(WidgetEvent, {0xa7e0c7a2, 0xe2cf, 0x4b11, {0xa4, 0x1b, 0x9, 0x77, 0x47, 0x6a, 0xa7, 0x70}});
