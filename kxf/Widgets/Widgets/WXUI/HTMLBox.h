...
#include "kxf/Widgets/WindowRefreshScheduler.h"
...
namespace kxf::WXUI
{
	class KXF_API HTMLBox: public EvtHandlerWrapper<HTMLBox, UI::WindowRefreshScheduler<wxSystemThemedControl<wxHtmlWindow>>>, public wxTextEntry
	{
		public:
